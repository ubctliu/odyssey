...
export default function Component() {
  ...
  return (
    <div className="h-screen flex flex-col justify-normal items-center bg-slate-350">
      ...
      <main className="mt-2 absolute h-1/2 w-3/4 2xl:h-3/4 mx-auto flex flex-col p-4 items-center border border-b-6 border-solid rounded-2xl border-b-slate-100 shadow-2xl backdrop-blur-md bg-white/30">
        ...
        <div className="flex flex-col space-x-6 space-y-6 items-center">
          ...
          <div className="flex items-center justify-center w-1/2 h-3/4 2xl:w-full 2xl:h-full 2xl:space-x-6 2xl:space-y-6">
            <Carousel>
              {userTripData.map((trip) => {
                return (
                  <div key={trip.id} className="mx-auto flex align-center items-center w-1/2 h-4/5 2xl:w-1/2 2xl:h-3/5">
