...
const Hero = () => {
    ...
    return (
        ...
        className="w-screen flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container pl-20" data-aos='fade-right'>
            ...
            <div className="py-6 flex items-center text-sm text-neutral-900 uppercase before:flex-[1_1_0%] before:border-t before:me-6 after:flex-[1_1_0%] after:border-t after:ms-6 dark:text-gray-500 dark:before:border-gray-600 dark:after:border-gray-600">Or</div>
